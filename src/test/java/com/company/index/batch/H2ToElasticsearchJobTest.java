...
/**
 * H2 到 Elasticsearch 的 Job 测试
 */
@SpringBootTest(classes = {TestBatchConfig.class, FullIndexJobConfig.class, IncrementalIndexJobConfig.class})
@ActiveProfiles("h2-es")
public class H2ToElasticsearchJobTest {
    ...
    void testFullIndexJob() throws Exception {
        ...
        // 运行 Job
        System.out.println("========================================");
        System.out.println("开始运行 H2 到 Elasticsearch 全量索引 Job");
        System.out.println("========================================");
        ...
        System.out.println("✓ H2 到 Elasticsearch 全量索引 Job 执行成功");
    ...
    void testIncrementalIndexJob() throws Exception {
        ...
        // 运行 Job
        System.out.println("========================================");
        System.out.println("开始运行 H2 到 Elasticsearch 增量索引 Job");
        System.out.println("========================================");
        ...
        System.out.println("✓ H2 到 Elasticsearch 增量索引 Job 执行成功");
        System.out.println("Job 状态: " + jobExecution.getExitStatus().getExitCode());
        System.out.println("处理记录数: " + jobExecution.getStepExecutions().iterator().next().getReadCount());
    }
}

...
/**
 * Oracle 到 File 的 Job 测试
 */
@SpringBootTest(classes = {com.company.index.Application.class, TestBatchConfig.class})
@ActiveProfiles("oracle-file")
public class OracleToFileJobTest {
    ...
    void testFullIndexJob() throws Exception {
        ...
        // 运行 Job
        System.out.println("========================================");
        System.out.println("开始运行 Oracle 到 File 全量索引 Job");
        System.out.println("========================================");
        ...
        System.out.println("✓ Oracle 到 File 全量索引 Job 执行成功");
    ...
    void testIncrementalIndexJob() throws Exception {
        ...
        // 运行 Job
        System.out.println("========================================");
        System.out.println("开始运行 Oracle 到 File 增量索引 Job");
        System.out.println("========================================");
        ...
        System.out.println("✓ Oracle 到 File 增量索引 Job 执行成功");
        System.out.println("Job 状态: " + jobExecution.getExitStatus().getExitCode());
        System.out.println("处理记录数: " + jobExecution.getStepExecutions().iterator().next().getReadCount());
    }
}
